...
# 追加自定义内核配置项
echo "CONFIG_YT9215_SWITCH=y
CONFIG_BRIDGE_VLAN_FILTERING=y
CONFIG_LEDS_GPIO=y
CONFIG_SWCONFIG_LEDS=y" >> target/linux/rockchip/rk35xx/config-5.10
...
\$(call Device/rk3588)
  ...
  DEVICE_DTS := rk3588-bdy-g98-nas
endef
TARGET_DEVICES += bdy_g98-nas" >> target/linux/rockchip/image/rk35xx.mk
